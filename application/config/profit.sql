...
INSERT INTO `back` (`id`, `passd`, `names`, `statu`, `type`) VALUES
(1, 'c4055e3a20b6b3af3d10590ea446ef6c', 'vv', 'TRUE', 'admin');
...
INSERT INTO `super` (`id`, `passd`, `names`, `statu`, `type`) VALUES
(1, 'c4055e3a20b6b3af3d10590ea446ef6c', 'vv', 'TRUE', 'admin');
...
(1, 4, 'TX1274405513', 'loan', 70000, '2017-08-29 17:06:07', 'Loan Request of $70000 to Account 1343756497 Reference# TX1274405513', '1343756497', 'Transfered', '2017-08-29 17:06:07', 'WANTS A LOAN', '2018-01-18 16:31:29'),
(2, 4, 'TX1337749439', 'loan', 5555, '2017-08-29 17:11:19', 'Loan Request of $5555 to Account 1343756497 Reference# TX1337749439', '1343756497', 'APPROVED', '2017-08-29 17:11:19', 'WANTS A LOAN', '2018-01-19 00:10:13'),
(3, 4, 'TX1358824548', 'loan', 3000, '2018-01-18 16:22:02', 'Loan Request of $3000 to Account 1343756497 Reference# TX1358824548', '1343756497', 'APPROVED', '2018-01-18 16:22:02', 'WANTS A LOAN', '2018-01-18 16:54:59');
...
CREATE TABLE `tbl_loan_pay` (
  ...
  `tdatel` varchar(40) NOT NULL,
  `commentsl` varchar(200) NOT NULL,
  `bal_to_pay` varchar(100) NOT NULL,
...
INSERT INTO `tbl_loan_pay` (`id`, `user_id`, `tx_nol`, `tx_typel`, `amountl`, `datel`, `user_acct`, `to_accnol`, `statusl`, `tdatel`, `commentsl`, `bal_to_pay`, `loan_id`) VALUES
...
INSERT INTO `tbl_loan_us` (`id`, `userIdl`, `tx_nol`, `tx_typel`, `amountl`, `datel`, `availb_amt`, `to_accnol`, `statusl`, `rdate`, `commentsl`, `bal_to_pay`, `ramount`, `bal_pay`, `signature`, `rate`, `date_apprv`) VALUES
(1, 4, 'TX1274405513', 'loan', 70000, '2017-08-29 17:06:07', 0, '1343756497', 'PENDING', '2017-08-29 17:06:07', 'WANTS A LOAN', '', 0, 0, '', 0, ''),
(2, 4, 'TX1337749439', 'loan', 5555, '2017-08-29 17:11:19', 0, '1343756497', 'PENDING', '2017-08-29 17:11:19', 'WANTS A LOAN', '', 0, 0, '', 0, ''),
(3, 4, '', '', 0, '', 70000, '1343756497', 'Transfered', '2018-01-18 16:31:29', '', '77000', 70000, 77000, './uploads/users/sign/1b360b9286c75ee6655d061a503768f5.png', 10, '2018-01-18 16:41:27');
...
(4, 'dfdfd', 'dfdfd', '4786f3282f04de5b5c7317c490c6d922', '444@gmail.com', '0789105998', 'F', 'TRUE', 'USER', 'food', '', '', '08/22/2017', './uploads/users/sign/1b360b9286c75ee6655d061a503768f5.png'),
...
(8, 'v', 'v', 'v', 'v', 'v', 'v', 'v', 'v', 'v', '', '', '', ''),
(9, 'vcvvcv', 'vcvcvv', 'e11170b8cbd2d74102651cb967fa28e5', 'bamwinealbert@gmail.com', '0789105998', 'F', 'TRUE', 'USER', 'food', '', '', '08/30/2017', '');
...
CREATE TABLE `tbl_userc_accts` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL,
  `user_acct` varchar(10) NOT NULL,
  `user_bak_acc` varchar(100) NOT NULL,
  `user_bak_stut` varchar(100) NOT NULL,
  `user_bak_na` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_userc_accts` (`id`, `user_id`, `user_acct`, `user_bak_acc`, `user_bak_stut`, `user_bak_na`) VALUES
(1, 4, 'ACTIVE', 'centnarty bank', '', ''),
(2, 6, 'ACTIVE', 'gfggdgdfgdgd', '', ''),
(3, 7, 'INACTIVE', 'vxcvcvxv', '', ''),
(4, 9, 'INACTIVE', 'hfhfghfghfghfhfgh', '', ''),
(5, 4, '1343756497', '644664646464', 'Verfied', 'vvv');
