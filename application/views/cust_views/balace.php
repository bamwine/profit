                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?=$userbalinqure->fname."    ".$userbalinqure->lname;?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?=$userbalinqure->acc_no?> </p>
                                                        </div>
                                                    </div>
                                                </div>
												...
												<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <p class="form-control-static"> <?=$userbalinqure->balance?> </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!--/span-->
                            ...
                            <div class="table-responsive">
                                <table class="table color-table success-table">
                                    <thead>
                                        ...
                                        <tr>
                                            <td><?=$count=1;?></td>
                                            <td><?=h_nice_date($userbalinqure->tdate);?></td>
