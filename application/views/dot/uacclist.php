...
?>							
                                   ...
                                   <tr>
                                            ...
                                            <th><a href="<?=base_url('Admins/user_errors/'.h_encrypt_decrypt($n->user_id).'/udat');?>"><?=$n->acc_no; ?></a></th>
                                            <th><?=$n->balance; ?></th>
											<th><?=$atype ?></th>
					...
					<form class="form-horizontal" method="post" action="<?=base_url('Admins/changeAccStatus');?>">
					<div class="box-body">
					...
					<!-- /.box-footer -->
											...
											<th> <a href="<?=base_url('Admins/user_errors/'.h_encrypt_decrypt($n->user_id).'/stm');?>">Statement</a></th>
                                    </tr>
