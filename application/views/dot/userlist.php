...
?>							
                                   <tr>
                                           <th><?=$count;?></th>
                                            <th><a href="<?=base_url('Admins/user_errors/'.h_encrypt_decrypt($n->id).'/udat')?>"><?=$n->fname .' '.$n->lname;?></a></th>
                                            <th><?=$n->acc_no; ?></th>
											...
											<!--th><a href="<?=base_url('Admins/delusers/'.h_encrypt_decrypt($n->id))?>">Delete</a></th-->
			  ...
			  <br/><br/><br/><br/>
                <div class="modal-content">
				  ...
				  <div class="modal-body">
                   ...
                   <form class="form-horizontal" method="post" action="<?=base_url('Admins/changeUserStatus');?>">
              <div class="box-body">
			  ...
			  <br/><br/><br/><br/>
                <div class="modal-content">
				  ...
				  <div class="modal-body">
                   ...
                   <form class="form-horizontal" method="post" action="<?=base_url('Admins/changeUserEmail');?>">
              <div class="box-body">
                <div class="form-group">
