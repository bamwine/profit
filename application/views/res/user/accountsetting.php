                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal" method="post" action="<?=base_url('Dashboard/changepin/'.h_encrypt_decrypt($userdetails->id))?>">
                                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal"  method="post" action="<?=base_url('Dashboard/changepwd/'.h_encrypt_decrypt($userdetails->id))?>">
                                <div class="form-group">
                                    <label class="col-md-12" for="example-email">User Name</span>
                                    </label>
                                    <div class="col-md-12">
